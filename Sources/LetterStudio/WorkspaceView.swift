    ...
    private var rail: some View {
        VStack(spacing: 12) {
            Text("L.").font(.custom("Baskerville-Italic", size: 37)).foregroundStyle(Palette.brass)
                .accessibilityLabel("LetterStudio").padding(.top, 24).padding(.bottom, 22)
    ...
    private var header: some View {
        HStack(alignment: .center) {
            VStack(alignment: .leading, spacing: 10) {
                SmallLabel(text: "LetterStudio   /   Correspondence").foregroundStyle(Palette.brass)
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 0) {
            HStack(alignment: .top) {
                VStack(alignment: .leading, spacing: 10) {
                    SmallLabel(text: "LetterStudio / The archive").foregroundStyle(Palette.brass)
